...
WBMATERIALDIR = os.path.realpath(os.path.join(WBDIR, "materials/old"))
WBNEWMATERIALDIR = os.path.realpath(os.path.join(WBDIR, "materials/new"))
WBMODELDIR = os.path.realpath(os.path.join(WBDIR, "models"))
